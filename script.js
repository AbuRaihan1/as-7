...
const typeController = (e) => {
  ...
  if (newLetterCorrect) {
    ...
    correctWordType = correctWordType + 1;
    // console.log(correctWordType);
  } else {
...
const gameOver = () => {
  ...
  resultModal.innerHTML += `
    ...
    <p > your WPM is :  <span class="bold"> ${Math.round(wpmSpeed)} </span> </p>
...
setInterval(() => {
  ...
  wpmSpeed = correctWordType / 5 / (timeSpent / 60);
